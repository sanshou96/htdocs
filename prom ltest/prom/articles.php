...
<head>
    ...
    <link rel="stylesheet" href="styles/prom.css?v=1.5">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css?v=1.5">
    <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Open+Sans?v=1.5" />
      <link rel="stylesheet" href="styles/mediaqueries.css?v=1.5">
</head>
